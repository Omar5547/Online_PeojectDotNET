...
namespace Souq.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Price,Catid,Photo,SupplierName,EntryDate,ReviewUrl,Quantity")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Price,Catid,Photo,SupplierName,EntryDate,ReviewUrl,Quantity")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
